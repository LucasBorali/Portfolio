    ...
    <section ref={projects} id="projects" className={classes.projects}>
      ...
      <ul>
        {projects.map(project => (
          <li key={project.title} className={project === selectedProject ? classes.selected : classes.unselected} onClick={()=> selectProjectHandler(project)}>
